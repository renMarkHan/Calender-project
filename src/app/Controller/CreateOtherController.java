...
public class CreateOtherController extends Controller implements Initializable{
    ...
    public void save(){
        ...
        Task task = new Task(preferDate.toString(), deadlineDate, desc, false, priority, "other");
        if(model.add(task)){
