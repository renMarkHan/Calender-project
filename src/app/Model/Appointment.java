...
public class Appointment {
    ...
    public Appointment(int id, String preferDate, String deadlineDate, String description, boolean isNotification, boolean isFinish, int priority,String type) {
        super();
        this.id = id;
    ...
    public Appointment(String preferDate, String deadlineDate, String description, boolean isNotification, int priority,String type) {
        super();
        this.preferDate = preferDate;
        this.deadlineDate = deadlineDate;
        this.description = description;
